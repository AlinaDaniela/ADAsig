...
@WebServlet(name = "CountryInformation", urlPatterns = {"/CountryInformation"})
    ...
    private Country getInfo(String countryCode) {
       ...
       /* Country country = new Country();
        ...
        Country country = new Country();
                ...
                country.setCode("432432");
                country.setName("Romania");
                country.setContinent("Europa");
                country.setRegion("Terra");
                country.setLifeExpectancy(210.5);
                country.setGnp(322.0);
